...
DEFAULT_SSL_CERTFILE_TEMPLATE = '{host}.pem'
DEFAULT_SSL_KEYFILE_TEMPLATE = '{host}-key.pem'
...
class Settings(BaseSettings):
    ...
    use_https: bool = True
    ssl_certfile: str = DEFAULT_SSL_CERTFILE_TEMPLATE
    ssl_keyfile: str = DEFAULT_SSL_KEYFILE_TEMPLATE
    ...
    @property
    def certfile_path(self) -> Path:
        return Path(self.cert_dir, self.ssl_certfile.format(host=self.host))

    @property
    def keyfile_path(self) -> Path:
        return Path(self.cert_dir, self.ssl_keyfile.format(host=self.host))
